// System-Prompts 1:1 portiert aus windows-app/src/main/prompts.ts
// (urspruenglich BlitztextMac/Services/LLMService.swift)

import type { Settings, EmojiDensity } from "./types";
...
/** Dampf-ablassen-Prompt fuer Blitztext $%&!. */
